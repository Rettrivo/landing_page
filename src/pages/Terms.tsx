    ...
    <div className="w-full bg-paper">
      <article className="mx-auto max-w-3xl px-6 pb-24 pt-36">
        <span className="font-mono text-[11px] uppercase tracking-[0.22em] text-ink-soft">
          Legal · Last updated August 04, 2026
        </span>
        ...
        <div className="mt-12 space-y-10">
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Interpretation and Definitions</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              ...
              <h3 className="font-display text-lg font-semibold text-ink">Definitions</h3>
              ...
              <ul className="ml-6 list-disc space-y-2">
                ...
                <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Rettrivo LLC, 600 Wilshire Blvd, Los Angeles, CA 90013, USA.</p></li>
                ...
                <li><p><strong>Website</strong> refers to Rettrivo, accessible from <a href="https://rettrivo.com" rel="external nofollow noopener" target="_blank">https://rettrivo.com</a></p></li>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Acknowledgment</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Links to Other Websites</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Links from a Third-Party Social Media Service</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Termination</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Limitation of Liability</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Governing Law</h2>
            <div className="mt-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Disputes Resolution</h2>
            <div className="mt-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">For European Union (EU) Users</h2>
            <div className="mt-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">United States Legal Compliance</h2>
            <div className="mt-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Severability and Waiver</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              <h3 className="font-display text-lg font-semibold text-ink">Severability</h3>
              <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>

              <h3 className="font-display text-lg font-semibold text-ink">Waiver</h3>
              <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
            </div>
          </section>

          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Translation Interpretation</h2>
            <div className="mt-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Changes to These Terms and Conditions</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Contact Us</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
              <ul className="ml-6 list-disc space-y-2">
                <li>By email: support@rettrivo.com</li>
                <li>By visiting this page on our website: <a href="https://rettrivo.com" rel="external nofollow noopener" target="_blank">https://rettrivo.com</a></li>
                <li>By phone: +1 (213) 555-0108</li>
              </ul>
            </div>
          </section>
        </div>
