    ...
    <div className="w-full bg-paper">
      <article className="mx-auto max-w-3xl px-6 pb-24 pt-36">
        ...
        <div className="mt-12 space-y-10">
          <section>
            ...
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              ...
              <ul className="ml-6 list-disc space-y-2">
                ...
                <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Rettrivo LLC, 600 Wilshire Blvd, Los Angeles, CA 90013, USA.</p></li>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Collecting and Using Your Personal Information</h2>
            <div className="mt-3 space-y-5 text-[1.02rem] leading-relaxed text-ink-soft">
              <div>
                <h3 className="font-display text-lg font-semibold text-ink">Types of Data Collected</h3>
                <h4 className="mt-3 font-display text-base font-semibold text-ink">Personal Data</h4>
                <p className="mt-2">
              ...
              <div>
                <h4 className="font-display text-base font-semibold text-ink">Usage Data</h4>
              ...
              <div>
                <h4 className="font-display text-base font-semibold text-ink">Tracking Technologies and Cookies</h4>
                <p className="mt-2">
                  We use tracking technologies (such as cookies) to track the activity and to improve
                ...
                <p className="mt-2">
                  ...
                  on Your personal computer or mobile device when You go offline, while Session Cookies
                ...
                <p className="mt-2">
                  ...
                  Necessary / Essential Cookies described below) only with Your consent. You can withdraw
                  or change Your consent at any time using Our cookie preferences tool (if available) or
                  through Your browser/device settings. Withdrawing consent does not affect the
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Use of Your Personal Data</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Text Messages Privacy Notice</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              <p>
                ...
                below. When You opt in, We will collect and store the information You provide in
                connection with text messaging, such as Your phone number, the date and method of Your
              ...
              <p>
                Consent to receive text messages is not a condition of any purchase or use of Our
                Service. If You consent to receive SMS from Us, You agree to receive text messages from
                Us related to:
              </p>
              <ul className="ml-6 list-disc space-y-2">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Retention of Your Personal Data</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              <p>
              ...
              <p>
                ...
                periods below are maximum periods (&quot;up to&quot;) and We may delete or anonymize data sooner when it is no longer needed for the relevant purpose. We apply different retention periods to different categories of Personal Data based on the purpose of processing and legal obligations:
              </p>
              ...
              <p>
                ...
                be retained longer only where necessary for security, fraud prevention, or legal
                compliance.
              </p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Transfer of Your Personal Data</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              <p>
                ...
                This means that this information may be transferred to — and maintained on — computers
              ...
              <p>
                ...
                measures. The Company will take all steps reasonably necessary to ensure that Your data
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Delete Your Personal Data</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Disclosure of Your Personal Data</h2>
            <div className="mt-3 space-y-5 text-[1.02rem] leading-relaxed text-ink-soft">
              <div>
                <h3 className="font-display text-lg font-semibold text-ink">Business Transactions</h3>
              ...
              <div>
                <h3 className="font-display text-lg font-semibold text-ink">Law Enforcement</h3>
                <p className="mt-2">Under certain circumstances, the Company may disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
              </div>

              <div>
                <h3 className="font-display text-lg font-semibold text-ink">Other Legal Requirements</h3>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Security of Your Personal Data</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Children&apos;s and Minors&apos; Privacy</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              ...
              <p>
                ...
                Information from anyone under the age of 16, We will take steps to remove that
                information from Our servers as soon as reasonably possible.
              </p>
              <p>
                Some countries and states set a higher age at which an individual can consent to the
                processing of their own Personal Information. Where We rely on consent as a legal basis
                and the law applicable to a User sets an age higher than 16, We may require the consent
                of that User&apos;s parent or guardian before We collect and use their Personal Information.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold tracking-[-0.01em]">Changes to this Privacy Policy</h2>
            <div className="mt-3 space-y-3 text-[1.02rem] leading-relaxed text-ink-soft">
              <p>
